...
│       │   │   └── viewmodel/
│       │   │       └── TransactionViewModel.java # @HiltViewModel, LiveData + Transformations
│       │   ├── di/
│       │   │   └── AppModule.java                # Hilt @Module, DB + DAO Provides
│       │   ├── util/
│       │   │   ├── DateUtils.java                # java.time.LocalDate, YearMonth (Desugared)
│       │   │   ├── FormatUtils.java              # DecimalFormat 금액 포맷
│       │   │   └── CryptoUtils.java              # SHA-256 PIN 해시
│       │   ├── MainActivity.java
...
│       │   ├── navigation/
│       │   │   └── nav_graph.xml                 # 5개 Fragment 목적지
│       │   ├── menu/
│       │   │   └── bottom_nav_menu.xml           # 바텀 네비게이션 메뉴
│       │   ├── color/
